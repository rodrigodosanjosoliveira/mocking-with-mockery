...
import (
	...
	"github.com/rodrigodosanjosoliveira/mocking-with-mockery/internal/mocks/repomocks"
	"github.com/rodrigodosanjosoliveira/mocking-with-mockery/internal/models"
	"github.com/rodrigodosanjosoliveira/mocking-with-mockery/internal/services"
...
func TestProductService_Insert(t *testing.T) {
	...
	err := service.Insert(
		"2f1afe98-63c4-4f59-bcaf-1df835602bdb",
